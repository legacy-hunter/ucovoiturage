...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ucovoiturage', 'user' => 'root', 'password' => 'legacy', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Utilisateurs/UtilisateursBundle/Entity'), 1 => ($this->targetDirs[3].'/src/covoiturage/covoiturageBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Utilisateurs\\UtilisateursBundle\\Entity');
        $c->addDriver($b, 'covoiturage\\covoiturageBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('UtilisateursBundle' => 'Utilisateurs\\UtilisateursBundle\\Entity', 'covoiturageBundle' => 'covoiturage\\covoiturageBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1417a55d3298278f66deb5a89b732261b857fb7fc54af84a0ca192a0327e8153');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting' => 'FOSUserBundle:Resetting:email.txt.twig'), 'from_email' => array('confirmation' => array('kayewa89@gmail.com' => 'Admin de ucovoiturage'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \covoiturage\covoiturageBundle\Listener\SessionIdleHandler A covoiturage\covoiturageBundle\Listener\SessionIdleHandler instance.
     */
    protected function getMy_Handler_SessionIdleService()
    {
        return $this->services['my.handler.session_idle'] = new \covoiturage\covoiturageBundle\Listener\SessionIdleHandler($this->get('session'), $this->get('security.context'), $this->get('router'), 3600);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \covoiturage\covoiturageBundle\Listener\RedirectionListener A covoiturage\covoiturageBundle\Listener\RedirectionListener instance.
     */
    protected function getRedirectionlistenerService()
    {
        return $this->services['redirectionlistener'] = new \covoiturage\covoiturageBundle\Listener\RedirectionListener($this, $this->get('session'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.demo_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/profile', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $g->setProviderKey('main');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'main', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5545f43155111', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('kayewa89@gmail.com');
        $a->setPassword('overload@Hunter1989');
        $a->setAuthMode(NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/covoiturage/covoiturageBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/covoiturage/covoiturageBundle/Resources/views'), 'covoiturage');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'covoiturageBundle' => 'covoiturage\\covoiturageBundle\\covoiturageBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'ucovoiturage',
            'database_user' => 'root',
            'database_password' => 'legacy',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'kayewa89@gmail.com',
            'mailer_password' => 'overload@Hunter1989',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'kayewa89@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'overload@Hunter1989',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'kayewa89@gmail.com' => 'Admin de ucovoiturage',
            ),
