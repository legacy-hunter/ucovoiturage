...
class Utilisateurs extends \Utilisateurs\UtilisateursBundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'preference', 'annonces', 'voitures', 'reservations', 'commentaires', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'nom', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'prenom', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'sexe', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'telephone', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'ville', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'role', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'numPermis', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'compte', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'dateNaissance', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'matricule', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'cin', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'modeleVoiture', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'matriculeVoiture', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function getNumPermis()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumPermis', array());

        return parent::getNumPermis();
    }
    ...
    public function setNumPermis($numPermis)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumPermis', array($numPermis));

        return parent::setNumPermis($numPermis);
    }
    ...
    public function setPreference(\covoiturage\covoiturageBundle\Entity\preference $preference = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPreference', array($preference));
    ...
    public function getPreference()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPreference', array());
    ...
    public function addVoiture(\covoiturage\covoiturageBundle\Entity\voiture $voitures)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addVoiture', array($voitures));

        return parent::addVoiture($voitures);
    }
    ...
    public function removeVoiture(\covoiturage\covoiturageBundle\Entity\voiture $voitures)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeVoiture', array($voitures));

        return parent::removeVoiture($voitures);
    }
    ...
    public function getVoitures()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVoitures', array());
    ...
    public function setModeleVoiture($modeleVoiture)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setModeleVoiture', array($modeleVoiture));
    ...
    public function getModeleVoiture()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getModeleVoiture', array());
    ...
    public function setMatriculeVoiture($matriculeVoiture)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMatriculeVoiture', array($matriculeVoiture));

        return parent::setMatriculeVoiture($matriculeVoiture);
    }
    ...
    public function getMatriculeVoiture()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMatriculeVoiture', array());

        return parent::getMatriculeVoiture();
    }
